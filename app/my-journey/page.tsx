...
const Profile = async () => {
    ...
    return (
        <main className="min-lg:w-3/4"><section className="flex justify-between gap-4 max-sm:flex-col items-center">
            <div className="flex gap-4 items-center">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-sm text-muteed-foreground">{user.emailAddresses[0].emailAddress}</p>
                </div>
            </div>
